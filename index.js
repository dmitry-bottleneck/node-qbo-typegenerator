...
(async () => {
    ...
    await page.goto("https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/purchaseorder");
    ...
    // this works
    const methodAttributes = await page.$$eval(".method-attributes", parseSections);
