...
export type CreateBillObject = Omit<"BillObject","Id", "Balance", "HomeBalance", "RecurDataRef", "SyncToken", "TotalAmt"> 
export type CreateBillPaymentObject = Omit<"BillPaymentObject","Id", "SyncToken"> 
export type CreateCustomerObject = Omit<"CustomerObject","Id", "CurrencyRef", "FullyQualifiedName", "IsProject", "Level", "SyncToken"> 
export type CreateEstimateObject = Omit<"EstimateObject","Id", "HomeTotalAmt", "RecurDataRef", "SyncToken", "TaxExemptionRef", "TotalAmt"> 
export type CreateInvoiceObject = Omit<"InvoiceObject","Id", "Balance", "DeliveryInfo", "HomeBalance", "HomeTotalAmt", "InvoiceLink", "RecurDataRef", "SyncToken", "TaxExemptionRef", "TotalAmt"> 
export type CreatePaymentObject = Omit<"PaymentObject","Id", "SyncToken", "TaxExemptionRef", "UnappliedAmt"> 
export type CreatePurchaseOrderObject = Omit<"PurchaseOrderObject","Id", "RecurDataRef", "SyncToken", "TotalAmt"> 
export type CreateVendorObject = Omit<"VendorObject","Id", "Balance", "CurrencyRef", "SyncToken"> 
...
export type UpdateBillObject = Omit<"BillObject","Balance", "HomeBalance", "RecurDataRef", "TotalAmt"> & {
    Id: string;
    SyncToken: string;
    sparse?: boolean;
}
...
export type UpdateCustomerObject = Omit<"CustomerObject","CurrencyRef", "FullyQualifiedName", "IsProject", "Level"> & {
    Id: string;
    SyncToken: string;
    sparse?: boolean;
}
export type UpdateEstimateObject = Omit<"EstimateObject","HomeTotalAmt", "RecurDataRef", "TaxExemptionRef", "TotalAmt"> & {
    Id: string;
    SyncToken: string;
    sparse?: boolean;
}
export type UpdateInvoiceObject = Omit<"InvoiceObject","Balance", "DeliveryInfo", "HomeBalance", "HomeTotalAmt", "InvoiceLink", "RecurDataRef", "TaxExemptionRef", "TotalAmt"> & {
    Id: string;
    SyncToken: string;
    sparse?: boolean;
}
export type UpdatePaymentObject = Omit<"PaymentObject","TaxExemptionRef", "UnappliedAmt"> & {
    Id: string;
    SyncToken: string;
    sparse?: boolean;
}
export type UpdatePurchaseOrderObject = Omit<"PurchaseOrderObject","RecurDataRef", "TotalAmt"> & {
    Id: string;
    SyncToken: string;
    sparse?: boolean;
}
export type UpdateVendorObject = Omit<"VendorObject","Balance", "CurrencyRef"> & {
    Id: string;
    SyncToken: string;
    sparse?: boolean;
}
...
export interface BatchBillPaymentCreateItemRequest extends BatchItemRequestBase {
    BillPayment: CreateBillPaymentObject;
    operation: BatchOperation.CREATE;
}

export interface BatchBillPaymentUpdateItemRequest extends BatchItemRequestBase {
    BillPayment: UpdateBillPaymentObject;
    operation: BatchOperation.UPDATE;
}
export interface BatchBillPaymentDeleteItemRequest extends BatchItemRequestBase {
...
export interface BatchPurchaseOrderCreateItemRequest extends BatchItemRequestBase {
    PurchaseOrder: CreatePurchaseOrderObject;
    operation: BatchOperation.CREATE;
}

export interface BatchPurchaseOrderUpdateItemRequest extends BatchItemRequestBase {
    PurchaseOrder: UpdatePurchaseOrderObject;
    operation: BatchOperation.UPDATE;
}
export interface BatchPurchaseOrderDeleteItemRequest extends BatchItemRequestBase {
